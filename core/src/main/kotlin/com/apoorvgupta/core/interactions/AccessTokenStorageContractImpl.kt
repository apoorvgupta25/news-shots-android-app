...
import com.apoorvgupta.core.datastore.PreferenceKeys.ACCESS_TOKEN_PREFERENCES_FILE_NAME
...
class AccessTokenStorageContractImpl @Inject constructor(
    ...
    override suspend fun getAccessToken(): String? = context.dataStorePref.data.first().token
