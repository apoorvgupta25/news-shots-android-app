...
class HomeScreenUseCaseImpl @Inject constructor(
    ...
    override fun getHomeScreenContentData(): Flow<HomeDataModel> = getRecentNewsShotsUseCase.getRecentNewsShots()
    ...
    private suspend fun FlowCollector<HomeDataModel>.emitHomeSuccess(data: HomeDataModel) = emit(data)
